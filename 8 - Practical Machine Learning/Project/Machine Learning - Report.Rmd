...
Next, a correllation plot was produced in order to see how strong the variables relationships are with each other.
...
Then a model was fitted using the random forest classification function. The outcome was set to the training class and all the variables were used to predict.
